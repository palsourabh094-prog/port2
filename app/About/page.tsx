...
export default function AboutPage() {
  const schemaData = {
    ...
    "@type": "Organization",
    name: "PALINDUSTRIES International",
    url: "https://thePALINDUSTRIES.com",
    logo: "https://thePALINDUSTRIES.com/logo.png",
    description:
      "PALINDUSTRIES International is a 3D product animation agency serving clients in Miami, Los Angeles, New York, Canada, and the UK.",
    sameAs: [
      "https://www.instagram.com/PALINDUSTRIES",
      "https://www.linkedin.com/company/PALINDUSTRIES",
    ],
    address: {
      "@type": "PostalAddress",
    ...
    <>
      ...
      <section className="relative bg-black text-white py-20 px-6 md:px-12 lg:px-20 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">
          About PALINDUSTRIES International
        </h1>
      ...
      <section className="py-20 bg-black text-center text-white px-6">
        ...
        <p className="text-lg opacity-80 mb-8">
          Let PALINDUSTRIES International bring your products to life.
        </p>
        <a
          href="/contact"
